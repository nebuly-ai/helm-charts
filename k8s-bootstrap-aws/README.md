...
Helm chart for bootstrapping a Kubernetes cluster on AWS with all the dependencies required for installing [Nebuly](https://nebuly.com).
...
| backend.image.tag | string | `"v1.26.5"` |  |
...
| frontend.image.tag | string | `"v1.24.23"` |  |
...
| ingestionWorker.image.tag | string | `"v1.14.1"` |  |
