...
![Version: 1.30.15](https://img.shields.io/badge/Version-1.30.15-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0](https://img.shields.io/badge/AppVersion-1.0.0-informational?style=flat-square)
...
| backend.image.tag | string | `"v1.58.5"` |  |
...
| frontend.image.tag | string | `"v1.51.0"` |  |
