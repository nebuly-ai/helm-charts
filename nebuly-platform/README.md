...
![Version: 1.60.7](https://img.shields.io/badge/Version-1.60.7-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0](https://img.shields.io/badge/AppVersion-1.0.0-informational?style=flat-square)
...
| backend.image.tag | string | `"v1.84.2"` |  |
...
| frontend.image.tag | string | `"v1.65.5"` |  |
...
| ingestionWorker.image.tag | string | `"v1.57.17"` |  |
