...
![Version: 1.75.2](https://img.shields.io/badge/Version-1.75.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0](https://img.shields.io/badge/AppVersion-1.0.0-informational?style=flat-square)
...
| backend.image.tag | string | `"v1.98.4"` |  |
...
| frontend.image.tag | string | `"v1.73.3"` |  |
...
| ingestionWorker.image.tag | string | `"v1.65.4"` |  |
