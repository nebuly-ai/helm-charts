...
![Version: 1.50.2](https://img.shields.io/badge/Version-1.50.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0](https://img.shields.io/badge/AppVersion-1.0.0-informational?style=flat-square)
...
| backend.image.tag | string | `"v1.75.11"` |  |
...
| frontend.image.tag | string | `"v1.58.16"` |  |
...
| ingestionWorker.image.tag | string | `"v1.55.7"` |  |
