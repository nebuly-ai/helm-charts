...
| backend.image.tag | string | `"v1.120.5"` |  |
...
| frontend.image.tag | string | `"v1.82.0"` |  |
...
| ingestionWorker.image.tag | string | `"v1.92.0"` |  |
