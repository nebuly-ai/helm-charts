...
![Version: 1.79.0-alpha](https://img.shields.io/badge/Version-1.79.0--alpha-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0](https://img.shields.io/badge/AppVersion-1.0.0-informational?style=flat-square)
...
| backend.image.tag | string | `"v1.99.16"` |  |
...
| frontend.image.tag | string | `"v1.73.9"` |  |
...
| ingestionWorker.image.tag | string | `"v1.65.7"` |  |
