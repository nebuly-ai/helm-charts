...
![Version: 1.98.10](https://img.shields.io/badge/Version-1.98.10-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0](https://img.shields.io/badge/AppVersion-1.0.0-informational?style=flat-square)
...
| backend.image.tag | string | `"v1.115.14"` |  |
...
| frontend.image.tag | string | `"v1.81.3"` |  |
...
| frontend.v2.image.tag | string | `"v2.3.3"` |  |
...
| ingestionWorker.image.tag | string | `"v1.77.18"` |  |
