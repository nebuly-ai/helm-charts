...
![Version: 1.64.1](https://img.shields.io/badge/Version-1.64.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0](https://img.shields.io/badge/AppVersion-1.0.0-informational?style=flat-square)
...
| frontend.image.tag | string | `"v1.67.5"` |  |
...
| ingestionWorker.image.tag | string | `"v1.60.16"` |  |
