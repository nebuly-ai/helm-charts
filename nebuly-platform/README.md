...
![Version: 1.98.2](https://img.shields.io/badge/Version-1.98.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0](https://img.shields.io/badge/AppVersion-1.0.0-informational?style=flat-square)
...
| backend.image.tag | string | `"v1.115.5"` |  |
...
| frontend.image.tag | string | `"v1.80.9"` |  |
...
| frontend.v2.image.tag | string | `"v2.2.19"` |  |
...
| ingestionWorker.image.tag | string | `"v1.77.11"` |  |
...
| mcpServer.image | object | `{"pullPolicy":"IfNotPresent","repository":"ghcr.io/nebuly-ai/nebuly-mcp-server","tag":"v0.3.0"}` | The image to use for the MCP server deployment. |
