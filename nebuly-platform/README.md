...
![Version: 1.8.16](https://img.shields.io/badge/Version-1.8.16-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0](https://img.shields.io/badge/AppVersion-1.0.0-informational?style=flat-square)
...
| backend.image.tag | string | `"v1.31.7"` |  |
...
| frontend.image.tag | string | `"v1.28.4"` |  |
...
| ingestionWorker.image.tag | string | `"v1.19.7"` |  |
