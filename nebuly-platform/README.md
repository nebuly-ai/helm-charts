...
![Version: 1.50.4](https://img.shields.io/badge/Version-1.50.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0](https://img.shields.io/badge/AppVersion-1.0.0-informational?style=flat-square)
...
| backend.image.tag | string | `"v1.76.7"` |  |
...
| frontend.image.tag | string | `"v1.59.8"` |  |
