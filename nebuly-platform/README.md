...
![Version: 1.58.6](https://img.shields.io/badge/Version-1.58.6-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0](https://img.shields.io/badge/AppVersion-1.0.0-informational?style=flat-square)
...
| backend.image.tag | string | `"v1.82.14"` |  |
...
| frontend.image.tag | string | `"v1.63.7"` |  |
...
| ingestionWorker.image.tag | string | `"v1.57.7"` |  |
