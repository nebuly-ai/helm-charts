...
![Version: 1.97.4](https://img.shields.io/badge/Version-1.97.4-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0](https://img.shields.io/badge/AppVersion-1.0.0-informational?style=flat-square)
...
| frontend.v2.image.tag | string | `"v2.2.9"` |  |
...
| ingestionWorker.image.tag | string | `"v1.77.9"` |  |
