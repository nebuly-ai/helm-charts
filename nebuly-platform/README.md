...
![Version: 1.65.0](https://img.shields.io/badge/Version-1.65.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0](https://img.shields.io/badge/AppVersion-1.0.0-informational?style=flat-square)
...
| auth.image.tag | string | `"v1.20.15"` |  |
...
| backend.image.tag | string | `"v1.89.10"` |  |
...
| eventIngestion.image.tag | string | `"v1.16.5"` |  |
...
| frontend.image.tag | string | `"v1.67.16"` |  |
...
| ingestionWorker.image.tag | string | `"v1.60.17"` |  |
