...
![Version: 1.18.12](https://img.shields.io/badge/Version-1.18.12-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0](https://img.shields.io/badge/AppVersion-1.0.0-informational?style=flat-square)
...
| eventIngestion.image.tag | string | `"v1.9.3"` |  |
...
| frontend.image.tag | string | `"v1.47.1"` |  |
...
| ingestionWorker.image.tag | string | `"v1.37.1"` |  |
...
| ingestionWorker.settings.enableSubTopic | bool | `false` |  |
| ingestionWorker.settings.subTopicUseOnlyCustom | bool | `false` |  |
| ingestionWorker.settings.topicUseOnlyCustom | bool | `false` |  |
