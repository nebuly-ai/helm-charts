...
![Version: 1.62.9](https://img.shields.io/badge/Version-1.62.9-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0](https://img.shields.io/badge/AppVersion-1.0.0-informational?style=flat-square)
...
| backend.image.tag | string | `"v1.85.17"` |  |
...
| ingestionWorker.image.tag | string | `"v1.59.1"` |  |
