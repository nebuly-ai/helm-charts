...
![Version: 1.68.5](https://img.shields.io/badge/Version-1.68.5-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0](https://img.shields.io/badge/AppVersion-1.0.0-informational?style=flat-square)
...
| backend.image.tag | string | `"v1.93.17"` |  |
...
| frontend.image.tag | string | `"v1.70.10"` |  |
...
| ingestionWorker.image.tag | string | `"v1.62.13"` |  |
