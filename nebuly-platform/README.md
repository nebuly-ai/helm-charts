...
![Version: 1.30.3](https://img.shields.io/badge/Version-1.30.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.0.0](https://img.shields.io/badge/AppVersion-1.0.0-informational?style=flat-square)
...
| backend.image.tag | string | `"v1.57.27"` |  |
...
| frontend.image.tag | string | `"v1.50.35"` |  |
...
| fullProcessing.settings.processingDelay | int | `0` | Seconds of delay between processing. |
...
| ingestionWorker.image.tag | string | `"v1.47.27"` |  |
